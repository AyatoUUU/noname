(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main-feedback")) new core(".slider-main-feedback", {
        ...
        if (document.querySelector(".bottom-feedback__slider")) new core(".bottom-feedback__slider", {
            ...
            effect: "fade",
            pagination: {
                el: ".bottom-feedback__swiper-pagination",
                clickable: true,
                type: "fraction"
            },
            scrollbar: {
                el: ".bottom-feedback__swiper-scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".bottom-feedback__swiper-button-prev",
                nextEl: ".bottom-feedback__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
    ...
    btnSidebar.addEventListener("click", (function() {
        ...
        sidebar.classList.toggle("_show-sidebar");
        content.classList.toggle("blur");
    }));
    const script_textarea = document.getElementById("submit-review-review");
    script_textarea.addEventListener("keyup", (function() {
